...
$polyfill_path = ONE_CLICK_CLOSE_COMMENTS_PLUGIN_DIR . '/vendor/yoast/phpunit-polyfills/phpunitpolyfills-autoload.php';
...
function _manually_load_plugin() {
	require ONE_CLICK_CLOSE_COMMENTS_PLUGIN_FILE;
}
