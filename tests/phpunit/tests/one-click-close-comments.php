...
class One_Click_Close_Comments_Test extends WP_UnitTestCase {
	...
	public function test_handle_column_data_with_comments_open_when_user_does_not_have_caps() {
		...
		$expected = '<span data-nonce="%s" class="comment_state comment_state-1" title="Comments are open." aria-hidden="true"><span class="dashicons dashicons-admin-comments"></span></span>';
	...
	public function test_handle_column_data_with_comments_closed_when_user_does_not_have_caps() {
		...
		$expected = '<span data-nonce="%s" class="comment_state comment_state-0" title="Comments are closed." aria-hidden="true"><span class="dashicons dashicons-admin-comments"></span></span>';
