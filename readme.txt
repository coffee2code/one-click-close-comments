...
Tags: comments, close comments, open comments, admin
...
1. Unzip `one-click-close-comments-v1.0.zip` inside the `/wp-content/plugins/` directory for your site
...
= After activating the plugin, why can't I see the color-coded indicator next to each post on the 'Edit Posts' admin page? =
